...
[TREK-Plugins]() GitHub repo. There is
...
The entry follows [`schema/plugin-entry.schema.json`](/blob/main/schema/plugin-entry.schema.json);
[`schema/example-entry.json`](/blob/main/schema/example-entry.json)
